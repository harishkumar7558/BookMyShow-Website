...
<footer class="py-sm-10 py-md-10 py-xl-6">
  <div class="container-fluid bg-black py-3 py-md-6 py-xl-9 py-xxl-10">
    <div class="row justify-content-center">
      <div class="col-11">
      
        <div class="list d-flex justify-content-evenly">
        <h4 class="text-light">List Your Show</h4>
        <h4 class="text-light">Got a show.event,activeity or a great experence?Partner with us & get listed on bookmyshow</h4>
        <button class="btn btn-danger">Connect Today</button>
        </div>
        <img class="mt-5 mb-3"src="./images/customer.PNG" width={"100%"}/>
        {/* <!-- Widgets - Bootstrap Brain Component --> */}
        <section class="mb-4 mb-md-5 mb-xl-9 mb-xxl-10">
          <div class="row gy-md-0">
            <div class="col">
              <div class="link-wrapper">
                <h1 class="mb-3 fs-6 text-light">MOVIES IN BOOK MY SHOW</h1>
                <ul class="m-0 list-unstyled">
                  <li class="mb-1">
                    ...
                    <p class="text-light">Being kind to others charges no money. It is a unique characteristic of showing love and caring for others selflessly. It is an act of making others happy without any specific reasons. This act helps in maintaining a long-lasting relationship based on honesty and loyalty. We were taught to be kind, be modest to everyone, take up various responsibilities, set our priorities, and make decisions when we were kids. Being kind is a sense of honesty, purity, loyalty, happiness, and integrity. Since we live in a society and share various relationships, we must make sure that our behaviour and actions do not harm others.</p>
                  </li>
                  <li class="mb-1">
                    <a href="#!" class="link-opacity-75 link-underline-opacity-0 link-opacity-100-hover link-underline-opacity-100-hover link-offset-1 link-light">
                      Enterprise
        ...
        <img class=""src="./images/Capturefoot.PNG" width={"10%"}/>
            ...
            <div class="col-12 col-md-6">
              ...
              <div class="credit-wrapper d-block text-secondary fs-9 text-light text-center text-md-start">
                Built by<a href="https://bootstrapbrain.com/" class="link-light text-decoration-none">
                  bookmyshow</a> with <span class="text-primary">&#9829;</span>
              </div>
            </div>
            <div class="col-12 col-md-6">
